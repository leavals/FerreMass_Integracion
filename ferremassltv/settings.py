...
SECRET_KEY = 'django-insecure-2%hgd2f&f4@ovuh!w&##fy^f5ao9u-ql(gy%p+g819#bxxy%#f'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'DESKTOP-H3D9MUF']
...
ROOT_URLCONF = 'ferremassltv.urls'
...
WSGI_APPLICATION = 'ferremassltv.wsgi.application'
